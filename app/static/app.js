...
function renderKnowledgeState(i,w){
  ...
  setList('ksObserved',[
    ...
    deployment?`${deployment.attributes?.firmware||'monitoring image'} active in the review window`:'Active monitoring image is not established',
