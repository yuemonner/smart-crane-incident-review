...
function renderUnexpectedShell(){
  ...
  document.querySelector('.related-memory').innerHTML='<span class="eyebrow">RELATED MEMORY</span><h3>Similar pattern detected with Crane-09</h3><p>Previous decision: revert to prior profile after repeated alert-delivery gaps. Outcome: alert delivery recovered after profile revert.</p><small>Historical decisions are context for review, not a recommendation.</small>';
